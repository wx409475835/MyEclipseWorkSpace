				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${bean.items }" var="bean">
								<tr class="active">
									...
									<td width="30%">
										<a target="_blank" href="${pageContext.request.contextPath}/products?method=show&pid=${bean.product.pid}"> ${bean.product.pdesc}</a>
									</td>
									<td width="20%">
