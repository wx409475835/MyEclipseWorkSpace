...
<body>
			...
			<!--
            	...
            	描述：菜单栏
            -->
			<div class="container-fluid" style="margin-bottom: 4px;margin-top: 6px;margin-left: 10px">
				<div class="col-md-4">
...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" method="post" action="${pageContext.request.contextPath }/user?method=register">
			 ...
			 <div class="form-group">
			  ...
			  <input type="radio" name="inlineRadioOptions" name="sex" id="inlineRadio1" value="1"> 男
			</label>
			<label class="radio-inline">
			  <input type="radio" name="inlineRadioOptions" name="sex" id="inlineRadio2" value="0"> 女
			</label>
			</div>
			  </div>		
			  <div class="form-group">
	...
	<div style="margin-top:50px;">
		...
		<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
			Copyright &copy; 2005-2016 图灵商城 版权所有
		</div>
