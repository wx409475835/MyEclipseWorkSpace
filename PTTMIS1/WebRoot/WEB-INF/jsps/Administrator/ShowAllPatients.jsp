...
<html>
			...
			$.ajax({
				...
				success:function(result){
					...
					if(result==0){
						...
						var bool = confirm("该病人已经结算,确认删除此病人信息和与此病人相关的所有信息吗？");
  ...
  <body>
  	<div class="showallcount-div">
  		<input name="hp_id" type="text" placeholder="请输入需要查询的ID或姓名"/>
   	...
   	<div class="table-bottom">
   		<div class="showallcount-div1">
	   		<table border="1px" cellpadding="0" cellspacing="0">
		    	...
		    	<tbody>
		    		<c:forEach items="${SelectAllPatients_hPatients }" var="hPatients">
			    		<tr>
