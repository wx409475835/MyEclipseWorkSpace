...
public class AdministratorServiceImpl implements AdministratorService{
	...
	@Override
	public List QueryLimitListHospital_Doctor(int startIndex, int pagesize) {
		return administratorMapper.QueryLimitListHospital_Doctor(startIndex, pagesize);
	}

	@Override
	public PageBean pageQueryHospital_Doctor(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_Doctor(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_Doctor();
	...
	@Override
	public int CountHospital_Doctor() {
		return administratorMapper.CountHospital_Doctor();
	}

	@Override
	public List QueryLimitListHospital_aoto(int startIndex, int pagesize) {
		return administratorMapper.QueryLimitListHospital_aoto(startIndex, pagesize);
	}

	@Override
	public int CountHospital_aoto() {
		return administratorMapper.CountHospital_aoto();
	}

	@Override
	public PageBean pageQueryHospital_aoto(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_aoto(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_aoto();
		QueryResult result = new QueryResult();
		result.setList(list);
		result.setTotalrecord(totalCount);
		pageBean.setTotalrecord(totalCount);
	...
	@Override
	public List QueryLimitListHospital_patient(int startIndex, int pagesize){
		return administratorMapper.QueryLimitListHospital_patient(startIndex, pagesize);
	}

	@Override
	public int CountHospital_patient() {
		return administratorMapper.CountHospital_patient();
	}

	@Override
	public PageBean pageQueryHospital_patient(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_patient(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_patient();
		QueryResult result = new QueryResult();
		result.setList(list);
		result.setTotalrecord(totalCount);
		pageBean.setTotalrecord(totalCount);
	...
	@Override
	public List QueryLimitListHospital_emr(int startIndex, int pagesize) {
		return  administratorMapper.QueryLimitListHospital_emr(startIndex, pagesize);
	}

	@Override
	public int CountHospital_emr() {
		return administratorMapper.CountHospital_emr();
	}

	@Override
	public PageBean pageQueryHospital_emr(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_emr(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_emr();
		QueryResult result = new QueryResult();
		result.setList(list);
		result.setTotalrecord(totalCount);
		pageBean.setTotalrecord(totalCount);
	...
	@Override
	public List QueryLimitListHospital_drug(int startIndex, int pagesize) {
		return administratorMapper.QueryLimitListHospital_drug(startIndex, pagesize);
	}

	@Override
	public int CountHospital_drug() {
		return administratorMapper.CountHospital_drug();
	}

	@Override
	public PageBean pageQueryHospital_drug(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_drug(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_drug();
		QueryResult result = new QueryResult();
		result.setList(list);
		result.setTotalrecord(totalCount);
		pageBean.setTotalrecord(totalCount);
	...
	@Override
	public List QueryLimitListHospital_treaterecord(int startIndex, int pagesize) {
		return administratorMapper.QueryLimitListHospital_treaterecord(startIndex, pagesize);
	}

	@Override
	public int CountHospital_treaterecord() {
		return administratorMapper.CountHospital_treaterecord();
	}

	@Override
	public PageBean pageQueryHospital_treaterecord(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_treaterecord(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_treaterecord();
		QueryResult result = new QueryResult();
		result.setList(list);
		result.setTotalrecord(totalCount);
		pageBean.setTotalrecord(totalCount);
	...
	@Override
	public List QueryLimitListHospital_inform(int startIndex, int pagesize) {
		return administratorMapper.QueryLimitListHospital_inform(startIndex, pagesize);
	}

	@Override
	public int CountHospital_inform() {
		return administratorMapper.CountHospital_inform();
	}

	@Override
	public PageBean pageQueryHospital_inform(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_inform(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_inform();
		QueryResult result = new QueryResult();
		result.setList(list);
		result.setTotalrecord(totalCount);
		pageBean.setTotalrecord(totalCount);
	...
	@Override
	public List QueryLimitListHospital_treatemoney(int startIndex, int pagesize) {
		return administratorMapper.QueryLimitListHospital_treatemoney(startIndex, pagesize);
	}

	@Override
	public int CountHospital_treatemoney() {
		return administratorMapper.CountHospital_treatemoney();
	}

	@Override
	public PageBean pageQueryHospital_treatemoney(QueryInfo queryInfo) {
		PageBean pageBean = new PageBean();
		//要想拿到PageBean 首先要拿到QueryResult
		List  list = administratorMapper.QueryLimitListHospital_treatemoney(queryInfo.getStartindex(),queryInfo.getPagesize());
		//查询 总记录数据
		int totalCount = administratorMapper.CountHospital_treatemoney();
		QueryResult result = new QueryResult();
		result.setList(list);
		result.setTotalrecord(totalCount);
		pageBean.setTotalrecord(totalCount);
