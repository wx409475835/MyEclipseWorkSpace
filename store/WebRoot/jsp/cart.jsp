							...
							<tbody>
								...
								<c:forEach items="${cart.items }" var="cart">
									<tr class="active">
										...
										<td width="10%">
											<input type="text" style="border: none;background: none;text-align: center;" readonly="readonly" name="count" value="${cart.count}" maxlength="4" size="10">
										</td>
										<td width="15%">
											<span class="subtotal">￥${cart.subtotal }</span>
										</td>
										<td>
											<a href="javascript:void(0)" onclick="removeFormCart('${cart.product.pid}')" class="delete">删除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
