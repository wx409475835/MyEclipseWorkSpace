...
<html>
  ...
  <div class="addcount-div1">
  	<p>修改用户个人信息/Update Doctor Account Informations</p>
	     ...
	     <form method="post" action="UpdateDoctorAccountAction.do">
	     	<table>
	     		<c:forEach items="${UpdateDcotorAccountSelectDoctorById_hDoctor}" var="hDoctor">
		     		...
		     		<tr>
		     			<td>&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;龄&nbsp;&nbsp;&nbsp;<input class="addconut-input" type="text" name="hd_age" onblur="CheckAge()" value="${hDoctor.hd_age }"/>&nbsp;<span id="hd_age"></span></td>
		     		</tr>
		     		<tr>
		     		...
		     		<tr>
		     			<td>&nbsp;&nbsp;特&nbsp;&nbsp;&nbsp;长&nbsp;&nbsp;&nbsp;<input class="addconut-input" onblur="return CheckSpeciality()" type="text" name="hd_speciality" value="${hDoctor.hd_speciality }"/>&nbsp;<span id="hd_speciality"></span></td>
		     		</tr>
		     		<tr>
		     			<td>&nbsp;&nbsp;职&nbsp;&nbsp;&nbsp;称&nbsp;&nbsp;
		     		...
		     		<tr>
		     			<td>&nbsp;手&nbsp;机&nbsp;号&nbsp;&nbsp;&nbsp;<input onblur="return CheckPhone()" class="addconut-input" type="text" name="hd_mobile" value="${hDoctor.hd_mobile }"/>&nbsp;<span id="hd_mobile"></span></td>
		     		</tr>
				     <tr>
		     			<td>预&nbsp;约&nbsp;信&nbsp;息&nbsp;<textarea class="addconut-input" placeholder="请输入预约信息" onblur="return CheckRi()" name="hd_ri">${hDoctor.hd_ri }</textarea>&nbsp;<span id="hd_ri"></span></td>
		     		</tr>
		     		<tr>
