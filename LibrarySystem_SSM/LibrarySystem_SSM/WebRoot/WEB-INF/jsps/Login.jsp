	    	...
	    	<table>
	    		...
	    		<tr style="height: 100px;">
	    			<td align="center" colspan="2" >
	    				...
	    				<input type="submit" value="注册" formaction="http://localhost:8888/LibrarySystem_SSM/Register.do" style="width: 110px;background-color: transparent;border-radius: 8px;height:40px;color: #6959CD"/>
	    			</td>
	    		</tr>
	    	</table>
	    </form>
