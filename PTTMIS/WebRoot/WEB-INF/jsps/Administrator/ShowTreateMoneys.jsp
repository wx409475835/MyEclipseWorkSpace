	  ...
	  <div class="table-bottom">
	   		<div class="showallcount-div1">
			    <table cellpadding="0" cellspacing="0" border="1px">
			    	...
			    	<c:forEach items="${SelectTreateMoney_treatemoneys.list }" var="hTreateMoney" varStatus="status">
			    		<tr class="${status.count%2==0?'even':'odd' }">
				    		...
				    		<td><button class="table-btn2"><a href="DeleteTreateMoneyAction.do?htm_id=${hTreateMoney.htm_id }"><img src="images/DeleteLogo.png" alt="删除"/>删除</a></button></td>
				    	</tr>
			    	</c:forEach>
			    </table>
			 </div>
