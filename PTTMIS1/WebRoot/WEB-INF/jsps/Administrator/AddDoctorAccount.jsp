...
<html>
  ...
  <body>
  	<div class="addcount-div1">
  		<p>添加医生用户信息/Add Doctor Account Information</p>
     ...
     <div class="addcount-div2">
     	<form method="post" action="AddDoctorAccountAction.do" onsubmit="return JudgeDoctor() & Checksubmit()">
     	<table>
     		<tr>
     		...
     		<tr>
     			<td><span class="ri">预约信息</span>
     			<select class="addconut-input" name="hd_ri">
     				<option value="是">是</option>
     				<option value="否">否</option>
     			</select>&nbsp;<span id="hd_ri"></span></td>
     		</tr>
     		<tr>
     			<td><input class="submit" id="submit" type="submit" onclick="return Checksubmit()" value="确认添加"/></td>
     		</tr>
     	</table>
     </form>
     </div>
