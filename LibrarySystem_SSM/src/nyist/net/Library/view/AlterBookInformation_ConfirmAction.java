...
@Component
public class AlterBookInformation_ConfirmAction implements HttpRequestHandler {
	...
	public void handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String book_id =(String)request.getSession(true).getAttribute("BookInformations_ID");
		...
		libraryService.updateBookInformation(bk);
