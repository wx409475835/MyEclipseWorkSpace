		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						<form id="formId" method="post" action="${pageContext.request.contextPath}/cart?method=add">
							...
							<div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">商城价 ￥:${product.shop_price }元/份</strong> 参 考 价: <del>￥${product.market_price }元/份</del>
							</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div>
						<center><strong>${product.pdesc}</strong></center>
					</div>
