   ...
   checkstAge() && checkstSex() && checkstTel() && checkstDept() && checkstAddress()">
			<table >
				<tr>
					...
					<td>
						<input class="input" type="text" name="BookName" onblur="checkstName()"
							onFocus="clearstName()">
				...
				<tr>
					...
					<td>
						...
						女  -->
						<input class="input" type="text" name="writer" onblur="checkstSex()">
				...
				<tr>
					...
					<td>
						<input class="input" type="text" name="price" onblur="checkstAge()"
							onFocus="clearstAge()">
						<span id="stAge1"></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input class="input" type="text" name="num" onblur="checkstTel()"
							onFocus="clearstTel()">
						<span id="stTel1"></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input class="input" type="text" name="BookDept" onblur="checkstDept()"
							onFocus="clearstDept()">
				...
				<tr>
					...
					<td>
						<input class="input" type="text" name="BookAddress" onblur="checkstAddress()"
