...
<html>
  ...
  <body>
    ...
    <div style="background-color:;border-color:#CDC9C9;border-style:inset;height: 30px;">
    	<table>
    		<tr>
    			...
    			<td><a href="http://localhost:8888/LibrarySystem_SSM/Main_u.do"><strong>首页</strong></a></td>
    			<td style="width: 40px;"></td>
    ...
    <hr>
    <center><iframe src="QY.do" name="aa" style="width: 1100px;height: 600px;border: none;'"></iframe></center>
    </c:if>
    <c:if test="${sessionScope.Login ==null }">
