  ...
  <body>
    <q:if test="${sessionScope.Login!=null }">
    	...
    	<table align="center" style="width: 350px;height: 100px;">
     		...
     		<tr>
     			<td><strong><font color="blue" size="5">图书价格:</font></strong></td><td><input id="price" onblur="return var_null(this) & var_price(this)" style="width: 210px;height: 35px;" name="book_price" type="text" placeholder="请输入价格"/></td>
     		</tr>
     		<tr>
     			<td><strong><font color="blue" size="5">图书数量:</font></strong></td><td><input id="count" onblur="return var_null(this) & var_count(this)" style="width: 210px;height: 35px;" name="book_count" type="text" placeholder="请输入数量"/></td>
     		</tr>
     		<tr>
     		...
     		<tr style="height: 120px;">
	     		<td align="center" colspan="2">
	     			...
	     			<input type="reset" value="重置" style="width:110px;background-color:transparent;border-radius: 8px;height:40px;color:#1818D7;"  formaction="Main.do"/>
	     		</td>
     		</tr>
     	</table>
    </form>
