...
public interface AdministratorService {
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_Doctor(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_aoto(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	/**
	 * 查询 表hospital_aoto 总记录数
	 * @return
	 */
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_patient(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	/**
	 * 查询 表hospital_aoto 总记录数
	 * @return
	 */
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_emr(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	/**
	 * 查询 表hospital_aoto 总记录数
	 * @return
	 */
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_drug(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	/**
	 * 查询 表hospital_aoto 总记录数
	 * @return
	 */
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_treaterecord(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	/**
	 * 查询 表hospital_treaterecord 总记录数
	 * @return
	 */
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_inform(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	/**
	 * 查询 表hospital_treaterecord 总记录数
	 * @return
	 */
	 ...
	 * @return
	 */
	public List QueryLimitListHospital_treatemoney(@Param("startIndex")int startIndex,@Param("pagesize")int pagesize);
	/**
	 * 查询 表hospital_treatemoney 总记录数
	 * @return
	 */
