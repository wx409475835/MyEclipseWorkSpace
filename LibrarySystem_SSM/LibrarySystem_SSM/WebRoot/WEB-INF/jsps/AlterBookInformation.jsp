    	...
    	<div>
	    	...
	    	<div>
				<table align="center" style="width: 350px;height: 100px;">
	     		...
	     		<tr>
	     			<td><strong><font color="blue" size="5">图书价格:</font></strong></td><td><input id="price" value="${bk.book_price }" onblur="return var_null(this) & var_price(this)" style="width: 210px;height: 35px;font-size:20px;" name="book_price" type="text"/></td>
	     		</tr>
	     		<tr>
	     			<td><strong><font color="blue" size="5">图书数量:</font></strong></td><td><input value="${bk.book_count }" onblur="return var_null(this)" style="width: 210px;height: 35px;font-size:20px;" name="book_count" type="text"/></td>
	     		</tr>
	     		<tr>
	     		...
	     		<tr style="height: 120px;">
		     		<td align="center" colspan="2">
		     			...
		     			<input type="submit" value="返回" style="width:110px;background-color:transparent;border-radius: 8px;height:40px;color:#1818D7;"  formaction="SelectBooks.do"/>
		     		</td>
	     		</tr>
	     		</table>
			</div>
