				    	...
				    	<table align="center" bgcolor="#FCFCFC" border="1">
				  			...
				  			<m:forEach items="${ sessionScope.SelectBookAsIdInBook }" var="bk">
				  				<tr>
				  					...
				  					<td><center><button type="button" style="width: 80px;height: 30px;border-radius:5px;color:#6B8E23;" onclick="var_Confirm()"><a href="http://localhost:8888/LibrarySystem_SSM/ReturnBooksAction.do?book_id=${bk.book_id }">归还</a></button></center></td>
				  				</tr>
				  			</m:forEach>
				  		</table>
				  		</m:if>
