  ...
  <body>
    ...
    <br/><br/><br/><br/><br/>
	    <c:if test="${ sessionScope.Login!=null}">
	    	<form action="AlterPerson_UserPasswordAction.do"  method="post">
		    	<table >
			    	<tr><td><font color="blue" size="5"><b>用&nbsp;户&nbsp;名:</b></font></td><td><input type="hidden" name="id" value="${sessionScope.UpdateUser.person_id }"/><input type="text" onblur="return var_user(this)" name="username" value="${sessionScope.UpdateUser.username}" style="font-size:20px;width: 190px;height: 40px;background-color: transparent;"/></td></tr>
		    		...
		    		<tr style="height: 100px;">
		    			<td align="center" colspan="2" >
		    				<input type="submit" value="修改" onclick="var_login()" style="width: 110px;background-color: transparent;border-radius: 8px;height:40px;color:#9ACD32"/> &nbsp; &nbsp; &nbsp;
		    				<input type="submit" value="返回" formaction="${basePath }SelectAllUser.do" style="width: 110px;background-color: transparent;border-radius: 8px;height:40px;color:#1818D7"/>
		    			</td> 
		    		</tr>
		    	</table>
		    </form>
