  	...
  	<div class="addcount-div1">
	    ...
	    <form method="post" action="UpdateHPatientAction.do">
	    	<table>
		    		...
		    		<tr>
		    			<td>&nbsp;&nbsp;&nbsp;&nbsp;生&nbsp;日&nbsp;&nbsp;
		    				<input class="addconut-input" style="width: 650px" type="text" name="hp_birthday" class="Wdate" id="date" value="${SelectPatientById_hPatient.hp_birthday }"/>
		    			</td>
		    		</tr>
		    		<tr>
		    			<td>入院时间
		    				<input class="addconut-input" style="width: 650px;" type="text" name="hp_tath" class="Wdate"  value="${SelectPatientById_hPatient.hp_tath }" id="tath-date"/>
		    			</td>
		    		</tr>
		    		<tr>
