				...
				<div class="navbar">
					<div class="navbar-inner">
					   <a class="brand" href="main.jsp"><i class="icon-home"></i>&nbsp;首页</a>
						<ul class="nav">
							<li><a href="pre?method=bookAdd"><i class="icon-pencil"></i>&nbsp;添加图书信息 </a></li>
							<li><a href="showAllBooks"><i class="icon-book"></i>&nbsp;图书信息维护 </a></li>
							<li><a href="RBorrow"><i class="icon-book"></i>&nbsp;图书借阅详情 </a></li>
							<li><a href="showReader"><i class="icon-user"></i>&nbsp;读者信息管理</a></li>
