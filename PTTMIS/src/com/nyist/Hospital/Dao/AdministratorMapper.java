package com.nyist.Hospital.Dao;
...
public interface AdministratorMapper {
	 ...
	 * @return
	 */
	public String AdministratorLogin(@Param("ha_username")String ha_username,@Param("ha_account")String ha_account,@Param("ha_password")String ha_password);
	/**
	 * 判断用户名是否存在
	 * @param ha_username
	 * @return
	 ...
	 * @param ha_name
	 */
	public void InsertToAuthority(String ha_name);
	/**
	 * 添加用户 -->医生用户
