  ...
  <body>
    ...
    <div align="center">
	    <form action="RegisterAction.do" name="Register_person" method="post">
	    	<table >
		    	<tr><td><font color="red" size="5">用&nbsp;户&nbsp;名:</font></td><td>&nbsp;&nbsp;<input type="text" onblur="return var_user(this) & var_username_len(this)" name="username" placeholder="please input your username" style="width: 190px;height: 40px;background-color: transparent;"/></td></tr>
		    	<tr style="height: 20px;"></tr>
		    	<tr><td><font color="red" size="5">密&nbsp;&nbsp;&nbsp;&nbsp;码:</font></td><td>&nbsp;&nbsp;<input type="password" id="pw1" onblur="return var_pass(this) & var_password_len(this)" size="20" placeholder="please input your password" style="width: 190px;height: 40px;background-color: transparent;'"/></td></tr>
	    		<tr><td><font color="red" size="5">确认密码:</font></td><td>&nbsp;&nbsp;<input type="password" id="pw2" onblur="return var_pass(this) & var_password_len(this)" onkeyup="validate()" name="password" size="20" placeholder="Confirm password " style="width: 190px;height: 40px;background-color: transparent;'"/></td><td><span id="there"></span></td></tr>
